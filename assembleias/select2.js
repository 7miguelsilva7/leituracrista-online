...
$.getScript('http://cdnjs.cloudflare.com/ajax/libs/select2/3.4.8/select2.min.js',function(){
  ...
  var select = $('#select31').select2();
  var select = $('#select32').select2();
  var select = $('#select33').select2();
  var select = $('#select34').select2();
  var select = $('#select35').select2();
  var select = $('#select36').select2();
  var select = $('#select37').select2();
