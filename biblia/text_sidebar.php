  ...
  <div id='box'>
    ...
    <div id='sidebar'>
      ...
      <div class="noSelect" id="Conf">
        ...
        <form id="formSearch" class="form-busca-site">
  ...
  <div id="myModal" class="modal">
    ...
    <div class="modal-content">
      ...
      <div style="font-size:16" id="versionsInfo">
        <span> Escolha a versão para leitura clicando nos links abaixo</span>
        <p></p>
        ...
        <p></p>
        (<a href="#"><span onClick="SetCookie('version','ACF','365')" style="cursor:pointer"><b>ACF</b></span></a>) Edição Corrigida e Revisada Fiel ao Texto Original.
        <p></p>
